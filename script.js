...
function updatePinnedItems() {
    ...
    addProjectDiv.innerHTML = '<div onclick="my_modal_1.showModal()" class="w-full h-32 flex justify-center bg-[#170E48] rounded-lg border border-yellow-400 mb-6 py-5 px-4 cursor-pointer">\n' +
        '                <div>\n' +
