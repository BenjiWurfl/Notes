...
function updatePinnedItems() {
    ...
    title.innerHTML = 'Projects' + '<div class="bg-[#8E2CDE]"><svg  onclick ="my_modal_1.showModal()" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1" fill="black" stroke-linecap="round" stroke-linejoin="round">' +
        '                                         <path d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path>' +
        '                                   </svg>' +
        '                               </div>';
    ...
    addProjectDiv.innerHTML = '<div onclick="my_modal_1.showModal()" class="w-full h-25 justify-center bg-[#170E48] rounded-lg border mb-6 py-5 px-4 cursor-pointer">\n' +
        '                <div>\n' +
        '                    <h4 class="text-white text-center font-bold mb-3"> Add Project </h4>\n' +
        '                </div>\n' +
        '                <div class="flex items-center text-black justify-center">\n' +
        '                        <svg  xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1" fill="black" stroke-linecap="round" stroke-linejoin="round">\n' +
        '                            <path d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path>\n' +
        '                        </svg>\n' +
