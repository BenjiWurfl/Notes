...
function loadNotesOfProject(project) {
    ...
    navContent.innerHTML = '<li>\n' +
        ...
        '            </li>' +
        '<li>\n' +
        '                <button type="button" onclick="backToProjects()" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100" data-project-i-d="ULdtmS212Jz2veOSMQdL" data-is-dropdown="false"><svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">\n' +
