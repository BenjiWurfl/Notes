...
function updatePinnedNotes(project) {
    ...
    editProjectButton.classList.add('edit-project', 'px-4', 'w-screen', 'font-bold', 'text-[#3019bd]', 'text-md', 'cursor-pointer', 'text-right', 'justify-end', 'items-end');
    editProjectButton.innerHTML = '<svg class="self-end justify-end"xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#3019BD">' +
