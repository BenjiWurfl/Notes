...
function addProjectToNavbar(project, containerForProjectCards) {
    ...
    const roundedDiv = document.createElement('div');
    roundedDiv.classList.add('rounded');
    roundedDiv.innerHTML = '<div class="group w-full h-25 flex flex-col justify-between bg-transparent rounded-lg shadow-lg mb-6 py-5 px-4 hover:px-0 hover:shadow-2xl cursor-pointer transition-all ease-in-out duration-300">\n' +
