...
function updatePinnedItems() {
    ...
    title.innerHTML = 'Projects' +
        '<div class="ml-2 bg-[#8E2CDE] w-10 h-10 rounded cursor-pointer flex justify-center items-center">' +
        '   <svg onclick="my_modal_1.showModal()" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="3" fill="white" stroke-linecap="round" stroke-linejoin="round">' +
        '       <path d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path>' +
        '   </svg>' +
        '</div>';
